# Historical audio processing notes

Archived revision history, including superseded sample selections and tuning.
See [current credits](../AUDIO-LICENSES.md) and the audio preparation scripts for
the current pack. Original source attribution is retained below.
