import {Autopilot} from '../simulation/autopilot.js?v=speed360';
import {advanceMotion,initialState,stateInSegment} from '../simulation/motion.js?v=speed360';
import {findCrossings} from '../simulation/crossings.js?v=turnouts-removed';
...
export class Transport{
 ...
 tick(){
  ...
  if(this.autopilot)this.controls=this.autopilot.update(this.predicted);
